...
const EditForm = () => {
  ...
  //to solve brower error ,The form is hidden until the page is fully loaded in the browser,
  // then it appears for the user to fill out.
  // This prevents rendering issues in Next.js apps
  ...
  useEffect(() => {
    ...
    const fetchPropertyData = async () => {
      try {
        ...
        //checks rates are null,if so make empty string
